...
## Induvidual work:
The paper is devoted to the use of convolutional neural networks (CNNs) for image classification from the CIFAR-10 dataset. A model with two convolutional and two fully connected layers was implemented, using ReLU, MaxPooling, Dropout and other techniques to improve the results.
